...
public class MainApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        {// Test Case 3
            ...
            Course c6 = new HybridCourse("CRN5", "Data Analysis12345678910111213", levels, "Mr John6", 5, meetDays, gtas);
            ...
            List<AvailableCourse<String,Course>> catalog2 = new ArrayList<AvailableCourse<String,Course>>();
            catalog2 = courseCatalog.getCatalog();
            //courseCatalog.sort();
            //System.out.println(courseCatalog.getCatalog());
